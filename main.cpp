...
static int detect_yolov8(const cv::Mat& bgr, std::vector<Object>& objects)
{
    ...
    // // yolov8.load_param("/home/minhvo/Documents/Yolov8_Ncnn_Segmentation/yolov8n-seg.param");
    // // yolov8.load_model("/home/minhvo/Documents/Yolov8_Ncnn_Segmentation/yolov8n-seg.bin");

    // yolov8.load_param("/home/root/config/yolov8n-seg.param");
    // yolov8.load_model("/home/root/config/yolov8n-seg.bin");
...
int main(int argc, char** argv)
{
    ...
    if(!videoCapture.isOpened())
    {
        ...
        while (true) {
            ...
            detect_yolov8(videoFrame, objects);
            ...
            draw_objects(videoFrame, objects);

            cv::imshow("VideoCapture", videoFrame);
